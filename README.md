...
Similarly, `kmeans_color.py` uses the ideal output segmentation file (out2.jpg) to calculate/evaluate the accuracy of the segmentation for the colored image. The code outputs TP rate, FP rate